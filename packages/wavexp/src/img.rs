...
pub fn House() -> Html {
    html! {
        <svg viewBox="0 0 100 100"><polygon points="20,60 50,20 80,60 70,60 70,80 30,80 30,60" /></svg>
    }
}
...
pub fn RightArrow() -> Html {
    html! {
        <svg viewBox="0 0 100 100"><polygon points="50,15 85,50 50,85 50,70 15,70 15,30 50,30" /></svg>
    }
}
...
pub fn LeftArrow() -> Html {
    html! {
        <svg viewBox="0 0 100 100"><polygon points="50,15 15,50 50,85 50,70 85,70 85,30 50,30" /></svg>
    }
}
