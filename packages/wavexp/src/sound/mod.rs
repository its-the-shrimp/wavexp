...
use std::{
    ...
    mem::{variant_count, replace},
    num::NonZeroUsize, rc::Rc};
use wasm_bindgen::JsCast;
use wasm_bindgen_futures::JsFuture;
use web_sys::{AudioNode, AudioBuffer, File, AudioBufferOptions};
use yew::{html, Html};
use wavexp_utils::{
    OptionExt,
    default,
...
impl Sub for Note {
    ...
    fn sub(self, rhs: Self) -> Self::Output {
        ...
        x.checked_sub(rhs.0 as isize).to_app_result().report().unwrap_or(x)
    }
}
